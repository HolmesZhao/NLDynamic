...
- (NSDate *)zwy_setATimeToDate:(ZWYDateModel *)dateModel  {
    ...
    NSTimeZone *timeZone = [[NSTimeZone alloc] initWithName:dateModel.timeZone ? dateModel.timeZone : @"Asia/Shanghai"];
    [greCalendar setTimeZone: timeZone];
    
    NSDateComponents *dateComponents = [greCalendar components:NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond  fromDate:self]; // [NSDate date]
