...
@interface ManualSnapshotsTutorialView : BaseViewController
{
    id <ManualSnapshotsTutorialViewDelegate> _delegate;
...
@property(nonatomic) __weak id <ManualSnapshotsTutorialViewDelegate> delegate; // @synthesize delegate=_delegate;
