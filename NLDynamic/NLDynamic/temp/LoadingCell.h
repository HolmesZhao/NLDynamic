...
@interface LoadingCell : NearLockListViewCell <NearLockListViewCellProtocol>
{
...
@property(retain, nonatomic) NSProgressIndicator *loading; // @synthesize loading=_loading;
